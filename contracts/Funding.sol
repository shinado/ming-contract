...
// uint private DIVIDER = 10000;
        ...
        )
    {
        ...
        int24 lowerTick = 887272;//curTick - (tickSpacing * TICK_SPACING_MULTIPLIER); //we don't really care about slipage so set tick high
        int24 upperTick = -887272;//curTick + (tickSpacing * TICK_SPACING_MULTIPLIER);
